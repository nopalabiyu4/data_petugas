...
<head>
	...
	<link rel="icon" href="dist/img/smkmadya.png">
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" data-widget="pushmenu" href="#">
						<i class="fas fa-bars text-white"> Anda Sebagai,
								<?= $_SESSION["ses_level"]; ?></i>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/smkmadya.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text"> Input Data Petugas</span>
			</a>
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://www.youtube.com/@SMKSMADYADEPOK">
					<strong> SMK Madya Depok</strong>
				</a>
				All rights reserved.
			</div>
			<b>Created 2023</b>
